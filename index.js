...
// 5. Call History Section: Show all called services with name & number. This will empty initially. when call button clicked it will filled dynamically also a Clear History button on the right and then clicking this button will remove all data from call history.
